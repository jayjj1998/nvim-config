...
vim.opt.guicursor =
	"n-c:block,v:hor20,i-ci-ve:ver25,r-cr:hor20,o:hor50,a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor,sm:block-blinkwait175-blinkoff150-blinkon175" -- cursor blinking and settings
...
local function get_notes_path()
  ...
  if os_release:match("linuxmint") then
    return vim.fn.expand("~/Documents/Notes")
  elseif os_release:match("Ubuntu") then
    return "/mnt/c/Users/Jay/Documents/Notes"
  else
